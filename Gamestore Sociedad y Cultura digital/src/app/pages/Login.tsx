...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0d1117] to-[#1b2838] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="bg-[#0a1525] border border-gray-700/50 rounded-lg p-8 shadow-2xl backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <a href="#" className="text-[#00c8ff] hover:text-cyan-300 text-sm font-medium">
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            ¿No tienes cuenta?{' '}
            <Link to="/register" className="text-[#00c8ff] hover:text-cyan-300 font-semibold">
              Regístrate
            </Link>
          </p>
        </div>
